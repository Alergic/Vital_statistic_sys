...
public class AdminLoginview extends JFrame {
	...
	public AdminLoginview() {
		...
		JLabel lblNewLabel = new JLabel("管理员登录界面");
		sl_contentPane.putConstraint(SpringLayout.WEST, lblNewLabel, 354, SpringLayout.WEST, contentPane);
		sl_contentPane.putConstraint(SpringLayout.EAST, lblNewLabel, -340, SpringLayout.EAST, contentPane);
		...
		sl_contentPane.putConstraint(SpringLayout.SOUTH, lblNewLabel, -52, SpringLayout.NORTH, lblNewLabel_1);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(textField.getText().equals(JDBC.Aid)&&textField_1.getText().equals(JDBC.Apassword)) {
					dispose();
